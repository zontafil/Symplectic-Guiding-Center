...
namespace Integrators{
	template <int DIM> class SymplecticExplicit2 : public SymplecticIntegrator<DIM>
	{
		public:
	...
	template <int DIM> SymplecticExplicit2<DIM>::SymplecticExplicit2(Config::Config* config) : SymplecticIntegrator<DIM>(config){
