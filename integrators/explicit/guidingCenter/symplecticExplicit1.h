...
namespace Integrators{
	template <int DIM> class SymplecticExplicit1 : public VariationalIntegrator<DIM>
	{
		public:
	...
	template <int DIM> SymplecticExplicit1<DIM>::SymplecticExplicit1(Config::Config* config) : VariationalIntegrator<DIM>(config){
		if (DIM!=8) throw invalid_argument("Invalid dimension for symplectic explicit 1: please use 8.");
