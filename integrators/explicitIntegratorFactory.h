...
namespace Integrators{
	template <int DIM> ExplicitIntegrator<DIM> *explicitIntegratorFactory(std::string const& integratorName, Config::Config* config){
		...
		else throw invalid_argument("Invalid explicit integrator "+ integratorName);
	}
