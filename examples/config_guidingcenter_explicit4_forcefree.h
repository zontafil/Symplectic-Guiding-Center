	...
	class Config : public ConfigInterface{
		public:
			Config() : ConfigInterface(){
				emField = "ForceFree"; //Tokamak,ForceFree,TwoDimField

				system = "GuidingCenter";
				integrator = "SymplecticExplicit4";

				h = 600; //timestep
				max_t = 1E6; //number of timesteps to compute
				...
				z.z0.head(DIM/2) << 0.050000000000000, 0.00000000000000 ,0.000000000000000 ,0.0000390000000000; //initial condition
